...
```text
https://ijudge.it.kmitl.ac.th/submissions/577129/overview
```
...
```text
input รับค่าที่1 รับทศนิยม  2-3 ตัวอักษร 
output เป็นค่าที่ผ่านการแปลผลอุณหภูมิ
Constraints อุณหภูมิ แต่ละตัวมีค่าต่างกันต้องแปลแล้วหาผลลัพ
```
...
```text
Step 1: รับค่า 3 อย่าง คือ ตัวเลขอุณหภูมิ, หน่วยเดิม, หน่วยใหม่ที่อยากได้
Step 2: เช็กหน่วยเดิม แล้วแปลงค่าให้เป็น C เอาไว้เป็นตัวกลางก่อน
Step 3: นำค่าเซลเซียส C นั้น มาแปลงต่อเป็น หน่วยใหม่ ตามที่ตามที่กำหนด
Step 4: printออกมาเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
ตรวจสอบกรณีที่ หน่วยต้นทางและหน่วยปลายทางเป็นหน่วยเดียวกัน
```
...
```text
เช็กว่าโปรแกรมรองรับ ตัวพิมพ์เล็ก
```
...
```text
ทำทุกอย่าง แต่ติดตรงสมการเลยได้คำแนะนำจากลุง
```
