...
```text
https://ijudge.it.kmitl.ac.th/submissions/576716/overview
```
...
```text
input รับค่า n จำนวนเต็ม
output เป้นเงินที่รวมค่าบริการ และ vat
Constraints:การที่ค่าบริการต้องขั้นต่ำ50 และ ไม่เกิน 1000 
```
...
```text
Step1 รับค่าจำนวนเต็ม 1 ค่า (ราคาอาหารและเครื่องดื่ม)
Step2 หาค่าบริการด้วยการหาร 10 
Step3 กำหนดฟังชัน if else ให้ค่าบริการ ถ้าน้อยกว่า 50 ตีเป็น 50 ถ้ามากว่า 1000 ตีเป็น 1000 
Step4 หาค่าราคาทั้งหมด นำค่าจำนวนเต็มมาบวกกับค่าบริการ
Step5แล้วคิดvat 7% จากราคาทั้งหมด โดยvat = (ราคาทั้งหมด / 100) * 7
Step6 printค่าทั้งหมด โดย ราคาทั้งหมด + vat
```
...
```text
ทดสอบการทำงานทั่วไปกรณีที่ Tip อยู่ในเกณฑ์ปกติ
```
...
```text
ทดสอบกรณีขอบเขตบนของเงื่อนไข tip เกิน1000
```
...
```text
ช่วยแนะนำการกำหนดให้ค่าบริการอยู่ในเกณ์ เช่น ถ้า ต่ำกว่า50 ให้เป็น50 ถ้าเกิน 1000 ให้เป็น 1000 ที่เหลือก็เป็นค่าตัวมันเอง
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำทุกอย่างด้วยตัวเอง แต่เอาไอเดียการคิดในการกำหนดมาจากคุณลุง
```
