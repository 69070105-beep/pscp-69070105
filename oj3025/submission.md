...
```text
https://ijudge.it.kmitl.ac.th/submissions/576936/overview
```
...
```text
input รับค่า 2 ค่า เดิอน กับวัน
output ฤดูตามเดือนวัน
Constraints ในเดือนที่3หารลงตัว หลังจากวันที่21จะเป็นฤดูถัดไป
```
...
```text
Step 1 รับค่าจำวนวเต็ม 2 ค่า
Step 2 ตรวจสอบ วันเดือนด้วย if else ตามเงื้อนไขของโจทย์
Step 3 print ฤดูที่ถูกต้อง
```
...
```text
ทดสอบกรณีทั่วไปที่อยู่กลางฤดูกาล
```
