...
```text
https://ijudge.it.kmitl.ac.th/submissions/560144/overview
```
...
```text
input รับคำเป็น str
output เป็นคำที่รับแค่กลับหน้าหลัง
Constraints ตอนoutputต้องแปลงเป็นพิมเล็ก
```
...
```text
Step 1 รับค่าเป็น str 
Step 2 กลับคำด้วยตัวแปรต่อด้วย[::-1]
Step 3 แล้วทำเป็นตัวเล็กตัวแปร.lower() ในฟังชัน def
Step 4 พิมออกมาด้วย print
```
...
```text
เพื่อทดสอบการทำงานพื้นฐานตามโจทย์
```
...
```text
สอบการใส่ตัวเลข สัญลักษณ์พิเศษ
```
